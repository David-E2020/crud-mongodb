          ...
          <div class="nav-right col pull-right right-menu p-0">
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown p-0">
                <button class="btn btn-primary-light" type="button"><a href="../salir.php"><i data-feather="log-out"></i>salir</a></button>
              </li>
            </ul>
          </div>
            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="home"></i><span>Estudiantes</span></a>
                    <ul class="nav-submenu menu-content">
                      <li><a href="index.php">Lista de estudiantes</a></li>
                    </ul>
                  </li>
