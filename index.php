        ...
        <div class="row">
          ...
          <div class="col-xl-7 p-0">    
            <div class="login-card">
              <form method="post" action="public/control.php" class="theme-form login-form">
                <h4>Inicio</h4>
                <h6>¡Bienvenido de nuevo! Ingrese a su cuenta.</h6>
                <div class="form-group">
                  <label>Nombre de usuario</label>
                  <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                    <input class="form-control" type="text" required="" id="usuario" name="usuario" placeholder="Nombre de usuario">
                  </div>
                </div>
                <div class="form-group">
                  <label>Contraseña</label>
                  <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                    <input class="form-control" type="password" id="pass1" name="pass1" required="" placeholder="*********">
                ...
                <div class="form-group">
                  ...
                  </div><a class="link" href="forget-password.html">¿Se te olvido tu contraseña?</a>
                </div>
                <div class="form-group">
